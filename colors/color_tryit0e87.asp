...
<!-- Mirrored from www.w3schools.com/colors/color_tryit.asp?hex=2E8B57 by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jul 2023 08:22:25 GMT -->
<head>
...
<h2 id="colorHex"></h2>
<h2 id="colorRgb"></h2>
<h3 style="font-size:1.01em;">The background color of the table below is: "#2E8B57", shown together with different text colors.</h3>
<div class="w3-responsive">
<table class="w3-table w3-bordered w3-border" style="background-color:#2E8B57">
