...
<!-- Mirrored from www.w3schools.com/python/python_classes.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:18:20 GMT -->
<head>
...
<a class="w3-right w3-btn" href="python_inheritance.asp">Next &#10095;</a>
</div>
<hr>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypythonb749.html?filename=demo_class1">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypythonbaf8.html?filename=demo_class2">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython10f4.html?filename=demo_class3">Try it Yourself &raquo;</a>
</div>
...
<p>The __str__() function controls what should be returned when the class object 
is represented as a string.</p>
<p>If the __str__() function is not set, the string representation of the object 
is returned:</p>

<div class="w3-example">
<h3>Example</h3>
<p>The string representation of an object WITHOUT the __str__() function:</p>
<div class="w3-code notranslate pythonHigh">
  class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; 
  self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br><br>p1 = Person(&quot;John&quot;, 
  36)<br>
  <br>print(p1)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython9550.html?filename=demo_class_str1">Try it Yourself &raquo;</a>
</div>
<div class="w3-example">
<h3>Example</h3>
...
<div class="w3-code notranslate pythonHigh">
  class Person:<br>&nbsp; def __init__(self, name, age):<br>&nbsp;&nbsp;&nbsp; 
  self.name = name<br>&nbsp;&nbsp;&nbsp; self.age = age<br><br>&nbsp;
  def __str__(self):<br>&nbsp;&nbsp;&nbsp; return f&quot;{self.name}({self.age})&quot;<br>
  <br>p1 = Person(&quot;John&quot;, 
  36)<br>
  <br>print(p1)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython6c53.html?filename=demo_class_str2">Try it Yourself &raquo;</a>
</div>
<hr>
...
<div class="w3-code notranslate pythonHigh">
  ...
  36)<br>p1.myfunc()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython6055.html?filename=demo_class4">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  ...
  36)<br>p1.myfunc()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython8709.html?filename=demo_class5">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  p1.age = 40</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython87d8.html?filename=demo_class6">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  del p1.age</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython3b7d.html?filename=demo_class7">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-code notranslate pythonHigh">
  del p1</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython5f27.html?filename=demo_class8">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython0c7c.html?filename=demo_class_pass">Try it Yourself &raquo;</a>
</div>

<a id="exercises"></a>
<hr>
<form autocomplete="off" id="w3-exerciseform" action="https://www.w3schools.com/python/exercise.asp?filename=exercise_classes1" method="post" target="_blank">
...
<p><a target="_blank" href="exercise37be.html?filename=exercise_classes1">Start the Exercise</a></p>
</div>
</form>
...
<!-- Mirrored from www.w3schools.com/python/python_classes.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:18:22 GMT -->
</html>