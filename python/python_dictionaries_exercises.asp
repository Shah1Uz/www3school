...
<!-- Mirrored from www.w3schools.com/python/python_dictionaries_exercises.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:17:54 GMT -->
<head>
...
<p>Try to insert the missing part to make the code work as expected:</p>

<hr>
<form autocomplete="off" id="w3-exerciseform" action="https://www.w3schools.com/python/exercise.asp?filename=exercise_dictionaries1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
...
<p><a target="_blank" href="exercise612d.html?filename=exercise_dictionaries1">Start the Exercise</a></p>
</div>
</form>


<p>Go to the Exercise section and test all of our Python Dictionary Exercises:</p>

<p>
<a href="exercise612d.html?filename=exercise_dictionaries1" target="_blank" class="w3-button w3-blue">Python Dictionary Exercises</a>
</p>
