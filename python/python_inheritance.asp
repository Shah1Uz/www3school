...
<!-- Mirrored from www.w3schools.com/python/python_inheritance.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:18:22 GMT -->
<head>
...
class Person:<br>&nbsp; def __init__(self, fname, lname):<br>&nbsp;&nbsp;&nbsp; 
  ...
  x.printname()</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython1f29.html?filename=demo_inheritance_parent">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-panel w3-note">
  <p><strong>Note:</strong> Use the <code class="w3-codespan">pass</code> 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython8fc1.html?filename=demo_inheritance_child">Try it Yourself &raquo;</a>
</div>
...
from its parent.</p>
<p>We want to add the <code class="w3-codespan">__init__()</code> function to the child class (instead of the <code class="w3-codespan">pass</code> keyword).</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython8398.html?filename=demo_inheritance_init">Try it Yourself &raquo;</a>
</div>

<p>Now we have successfully added the __init__() function, and kept the 
...
<p>Python also has a <code class="w3-codespan">super()</code> function that 
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypythondf7b.html?filename=demo_inheritance_super">Try it Yourself &raquo;</a>
</div>

<p>By using the <code class="w3-codespan">super()</code> function, you do not 
...
<div class="w3-code notranslate pythonHigh">
  ...
  = 2019</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypythoned2c.html?filename=demo_inheritance_add_prop">Try it Yourself &raquo;</a>
</div>
...
To do so, add another parameter in the __init__() function:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypythona9df.html?filename=demo_inheritance_add_prop2">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython0de7.html?filename=demo_inheritance_add_method">Try it Yourself &raquo;</a>
</div>
...
<hr>
<form autocomplete="off" id="w3-exerciseform" action="https://www.w3schools.com/python/exercise.asp?filename=exercise_inheritance1" method="post" target="_blank">
<h2>Test Yourself With Exercises</h2>
<div class="exercisewindow">
<h2>Exercise:</h2>
<p>What is the correct syntax to create a class named Student that will inherit properties and methods from a class named Person?</p>
<div class="exerciseprecontainer">
<pre>
class <input name="ex1" maxlength="15" style="width: 155px;">:
</pre>
</div>
<br>
<button type="submit" class="w3-btn w3-margin-bottom">Submit Answer &raquo;</button>
<p><a target="_blank" href="exercisefbb4.html?filename=exercise_inheritance1">Start the Exercise</a></p>
</div>
</form>
...
<!-- Mirrored from www.w3schools.com/python/python_inheritance.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:18:29 GMT -->
</html>