...
<!-- Mirrored from www.w3schools.com/python/python_lists_exercises.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:16:47 GMT -->
<head>
...
<form autocomplete="off" id="w3-exerciseform" action="https://www.w3schools.com/python/exercise.asp?filename=exercise_lists1" method="post" target="_blank">
...
<p>Go to the Exercise section and test all of our Python List Exercises:</p>

<p>
<a href="exercise95d8.html?filename=exercise_lists1" target="_blank" class="w3-button w3-blue">Python List Exercises</a>
</p>
