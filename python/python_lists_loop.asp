...
<!-- Mirrored from www.w3schools.com/python/python_lists_loop.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:16:23 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython8abc.html?filename=demo_list_loop">Try it Yourself &raquo;</a>
</div>

<p>Learn more about <code class="w3-codespan">for</code> loops in our <a href="python_for_loops.asp">Python For Loops</a> Chapter.</p>
...
<p>Use the <code class="w3-codespan">range()</code> and
<code class="w3-codespan">len()</code> functions to create a suitable iterable.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython0974.html?filename=demo_list_loop2">Try it Yourself &raquo;</a>
</div>
...
<p>You can loop through the list items by using a <code class="w3-codespan">while</code> loop.</p>

<p>Use the <code class="w3-codespan">len()</code> function to determine the length of the list,
...
<div class="w3-example">
<h3>Example</h3>
  <p>Print all items, using a <code class="w3-codespan">while</code> loop to go 
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypythonaa7f.html?filename=demo_list_while_loop">Try it Yourself &raquo;</a>
</div>

<p>Learn more about <code class="w3-codespan">while</code> loops in our 
...
<div class="w3-example">
<h3>Example</h3>
  <p>A short hand <code class="w3-codespan">for</code> loop that will print all items in a list:</p>
<div class="w3-code notranslate pythonHigh">
thislist = [&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;]<br>[print(x) for x in thislist]</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypythonee1e.html?filename=demo_list_loop_comprehensive">Try it Yourself &raquo;</a>
</div>
...
<!-- Mirrored from www.w3schools.com/python/python_lists_loop.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:16:26 GMT -->
</html>