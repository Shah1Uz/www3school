...
<!-- Mirrored from www.w3schools.com/python/python_math.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:19:10 GMT -->
<head>
...
<p>The <code class="w3-codespan">min()</code> and <code class="w3-codespan">max()</code> functions can be used to find the lowest or highest value in an iterable:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate pythonHigh">
    x = min(5, 10, 25)<br>y = max(5, 10, 25)<br><br>print(x)<br>print(y)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython7678.html?filename=demo_math_min_max">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan">abs()</code> function returns the absolute (positive) value of the specified number:</p>

<div class="w3-example">
  <h3>Example</h3>
  <div class="w3-code notranslate pythonHigh">
    x = abs(-7.25)<br><br>print(x)</div>
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypythone746.html?filename=demo_math_abs">Try it Yourself &raquo;</a>
</div>
...
<p>Return the value of 4 to the power of 3 (same as 4 * 4 * 4):</p>
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython94ae.html?filename=demo_math_pow">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypython7154.html?filename=demo_math_sqrt">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypythond2c9.html?filename=demo_math_ceil_floor">Try it Yourself &raquo;</a>
</div>
...
<div class="w3-example">
  ...
  <a target="_blank" class="w3-btn w3-margin-bottom" href="trypythonfa30.html?filename=demo_math_pi">Try it Yourself &raquo;</a>
</div>
<hr>


<h2>Complete Math Module Reference</h2>
<p>In our <a href="module_math.html">Math Module Reference</a> you will 
