...
<!-- Mirrored from www.w3schools.com/python/python_sets_add.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:17:15 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython4bd8.html?filename=demo_set_add">Try it Yourself &raquo;</a>
</div>
...
<p>To add items from another set into the current set, use the <code class="w3-codespan">update()</code> 
method.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypythonc514.html?filename=demo_sets_update">Try it Yourself &raquo;</a>
</div>
...
<p>The object in the <code class="w3-codespan">update()</code> method does not have 
to be a set, it can be any iterable object (tuples, lists, dictionaries etc.).</p>

<div class="w3-example">
<h3>Example</h3>
<p>Add elements of a list to at set:</p>
<div class="w3-code notranslate pythonHigh">
  thisset = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>
  mylist = [&quot;kiwi&quot;, &quot;orange&quot;]<br><br>
  thisset.update(mylist)<br>
  <br>print(thisset)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypythona4e5.html?filename=demo_sets_update2">Try it Yourself &raquo;</a>
</div>
...
<!-- Mirrored from www.w3schools.com/python/python_sets_add.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:17:17 GMT -->
</html>