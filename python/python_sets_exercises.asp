...
<!-- Mirrored from www.w3schools.com/python/python_sets_exercises.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:17:26 GMT -->
<head>
...
<hr>
<form autocomplete="off" id="w3-exerciseform" action="https://www.w3schools.com/python/exercise.asp?filename=exercise_sets1" method="post" target="_blank">
...
<p>Go to the Exercise section and test all of our Python Set Exercises:</p>

<p>
<a href="exercise016f.html?filename=exercise_sets1" target="_blank" class="w3-button w3-blue">Python Set Exercises</a>
</p>
