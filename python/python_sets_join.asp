...
<!-- Mirrored from www.w3schools.com/python/python_sets_join.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:17:18 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython27cf.html?filename=demo_set_union">Try it Yourself &raquo;</a>
</div>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython4d13.html?filename=demo_set_update2">Try it Yourself &raquo;</a>
</div>
...
<h2>Keep ONLY the Duplicates</h2>

<p>The <code class="w3-codespan">intersection_update()</code> method will keep only the items that are present in both sets.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Keep the items that exist in both set <code class="w3-codespan">x</code>, and set <code class="w3-codespan">y</code>:</p>
<div class="w3-code notranslate pythonHigh">
  x = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>y = {&quot;google&quot;, &quot;microsoft&quot;, &quot;apple&quot;}<br>
  <br>x.intersection_update(y)<br><br>print(x)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypythona68e.html?filename=demo_sets_intersection_update">Try it Yourself &raquo;</a>
</div>

<p>The <code class="w3-codespan">intersection()</code> method will return a <em>new</em> set, that only contains the items that are present in both sets.</p>

<div class="w3-example">
<h3>Example</h3>
<p>Return a set that contains the items that exist in both set <code class="w3-codespan">x</code>, and set <code class="w3-codespan">y</code>:</p>
<div class="w3-code notranslate pythonHigh">
  x = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;}<br>y = {&quot;google&quot;, &quot;microsoft&quot;, &quot;apple&quot;}<br>
  <br>z = x.intersection(y)<br><br>print(z)</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypythona6eb.html?filename=demo_sets_intersection">Try it Yourself &raquo;</a>
</div>

<hr>
<h2>Keep All, But NOT the Duplicates</h2>

<p>The <code class="w3-codespan">symmetric_difference_update()</code> method will 
keep only the elements that are NOT present in both sets.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython1cab.html?filename=demo_sets_symmetric_difference_update">Try it Yourself &raquo;</a>
</div>
<p>The <code class="w3-codespan">symmetric_difference()</code> method will return a new set,
that contains only the elements that are NOT present in both sets.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypythonecf4.html?filename=demo_sets_symmetric_difference">Try it Yourself &raquo;</a>
</div>
<div class="w3-panel w3-note">
  <p><strong>Note:</strong> The values <code class="w3-codespan">True</code>
...
<div class="w3-example">
<h3>Example</h3>
<p><code class="w3-codespan">True</code>
  and <code class="w3-codespan">1</code> is considered the same value:</p>
<div class="w3-code notranslate pythonHigh">
  x = {&quot;apple&quot;, &quot;banana&quot;, &quot;cherry&quot;, True}<br>y = {&quot;google&quot;, 
  1, &quot;apple&quot;, 2}<br>
  <br>z = x.symmetric_difference(y)
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython35f7.html?filename=demo_sets_duplicate_true2">Try it Yourself &raquo;</a>
</div>
...
<!-- Mirrored from www.w3schools.com/python/python_sets_join.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:17:25 GMT -->
</html>