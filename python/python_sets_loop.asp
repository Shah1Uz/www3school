...
<!-- Mirrored from www.w3schools.com/python/python_sets_loop.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:17:18 GMT -->
<head>
...
<p>You can loop through the set items by using a <code class="w3-codespan">for</code> 
loop:</p>
