...
<!-- Mirrored from www.w3schools.com/python/python_tuples_exercises.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:17:09 GMT -->
<head>
...
<form autocomplete="off" id="w3-exerciseform" action="https://www.w3schools.com/python/exercise.asp?filename=exercise_tuples1" method="post" target="_blank">
...
<p>Go to the Exercise section and test all of our Python Tuple Exercises:</p>

<p>
<a href="exercise41d0.html?filename=exercise_tuples1" target="_blank" class="w3-button w3-blue">Python Tuple Exercises</a>
</p>
