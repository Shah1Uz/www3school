...
<!-- Mirrored from www.w3schools.com/python/python_tuples_loop.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:17:03 GMT -->
<head>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython7bfd.html?filename=demo_tuple_loop">Try it Yourself &raquo;</a>
</div>
...
<p>Use the <code class="w3-codespan">range()</code> and <code class="w3-codespan">len()</code> functions to create a suitable iterable.</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypythonb95e.html?filename=demo_tuple_loop_index">Try it Yourself &raquo;</a>
</div>
...
<p>You can loop through the tuple items by using a <code class="w3-codespan">while</code> loop.</p>

<p>Use the <code class="w3-codespan">len()</code> function to determine the length of the tuple,
...
<div class="w3-example">
<h3>Example</h3>
<p>Print all items, using a <code class="w3-codespan">while</code> loop to go through all the index numbers:</p>
<div class="w3-code notranslate pythonHigh">
thistuple = ("apple", "banana", "cherry")<br>
i = 0<br>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython85e8.html?filename=demo_tuple_while">Try it Yourself &raquo;</a>
</div>
...
<!-- Mirrored from www.w3schools.com/python/python_tuples_loop.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:17:05 GMT -->
</html>