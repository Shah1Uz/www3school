...
<!-- Mirrored from www.w3schools.com/python/python_user_input.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:19:54 GMT -->
<head>
...
<a class="w3-right w3-btn" href="python_string_formatting.asp">Next &#10095;</a>
</div>
<hr>
...
<p>Python 3.6 uses the <code class="w3-codespan">input()</code> method. </p>
<p>Python 2.7 uses the <code class="w3-codespan">raw_input()</code> method. </p>
<p>The following example asks for the username, and when you entered the username, it gets printed on 
the screen:</p>
...
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpython6209.html?filename=demo_user_input3">Run Example &raquo;</a>
</div>

<div class="w3-example">
<h3>Python 2.7</h3>
<div class="w3-code notranslate pythonHigh">
  username = raw_input(&quot;Enter username:&quot;)<br>
print("Username 
  is: &quot; + username)<br>
</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="showpythonfc5e.html?filename=demo_user_input2">Run Example &raquo;</a>
</div>

<div class="w3-panel w3-note">

<p>Python stops executing when it comes to the <code class="w3-codespan">input()</code> function, and continues 
...
<!-- Mirrored from www.w3schools.com/python/python_user_input.asp by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2023 18:19:57 GMT -->
</html>