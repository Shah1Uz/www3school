...
<!-- Mirrored from www.w3schools.com/python/showpython.asp?filename=demo_mysql_show_tables by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Jul 2023 08:24:13 GMT -->
<head>
...
<!-- TryitLeaderboard -->
  ...
  <div id='div-gpt-ad-1428407818244-0'>
    <script type='text/javascript'>uic_r_o();</script>
  </div>
...
<div class="w3-bar" style="overflow:auto">
  ...
  <a id="getwebsitebtn" class="w3-button w3-bar-item w3-hover-white w3-hover-text-green w3-hide-small ga-tryit" href="../spaces/index-3.html" target="_blank">Get your <span class='w3-hide-medium'> own Python</span> server</a>
  ...
  <div id="textareacontainer">
    <div id="textarea">
      <div id="textareawrapper">
            ...
            <textarea autocomplete="off" id="textareaCode" wrap="logical" spellcheck="false">import mysql.connector
